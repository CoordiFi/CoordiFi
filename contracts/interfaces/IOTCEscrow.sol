...
interface IOTCEscrow {
    enum Status { CREATED, MAKER_LOCKED, BOTH_LOCKED, SETTLED, REFUNDED }

    event Initialized(address indexed maker, address assetA, address assetB, uint256 amountA, uint256 amountB);
    ...
    event Settled(address indexed maker, address indexed taker, uint256 amountA, uint256 amountB, uint256 fee);
